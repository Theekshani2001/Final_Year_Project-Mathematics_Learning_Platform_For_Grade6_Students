...
@Component({
  selector: 'app-g1-easy-content2',
  templateUrl: './g1-easy-content2.component.html',
  styleUrls: ['./g1-easy-content2.component.scss']
})
export class G1EasyContent2Component implements OnInit {
  ...
  goToNextGame(): void {
    ...
    window.location.href = '/dashboard/game-dashboard/game1/game1-content/game1-easy/game1-easy-content3'; // Replace with your next game URL
