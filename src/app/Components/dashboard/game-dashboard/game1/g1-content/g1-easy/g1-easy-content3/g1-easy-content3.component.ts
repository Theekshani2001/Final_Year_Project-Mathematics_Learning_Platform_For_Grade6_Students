...
@Component({
  selector: 'app-g1-easy-content3',
  templateUrl: './g1-easy-content3.component.html',
  styleUrls: ['./g1-easy-content3.component.scss']
})
export class G1EasyContent3Component implements OnInit {
