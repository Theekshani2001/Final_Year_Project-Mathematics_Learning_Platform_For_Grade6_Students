...
@Component({
  selector: 'app-g1-hard',
  templateUrl: './g1-hard.component.html',
  styleUrls: ['./g1-hard.component.scss']
})
export class G1HardComponent implements OnInit {
  ...
  private correctOrder: string[] = [
    ...
    'block16','block17','block18',
    'block19','block20','block21',
