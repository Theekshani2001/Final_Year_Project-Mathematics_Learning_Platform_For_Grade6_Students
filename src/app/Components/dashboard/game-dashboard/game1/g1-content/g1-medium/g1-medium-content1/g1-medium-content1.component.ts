...
@Component({
  selector: 'app-g1-medium-content1',
  templateUrl: './g1-medium-content1.component.html',
  styleUrls: ['./g1-medium-content1.component.scss']
})
export class G1MediumContent1Component implements OnInit {
  ...
  goToNextGame(): void {
    ...
    window.location.href = '/dashboard/game-dashboard/game1/game1-content/game1-medium/game1-medium-content2'; // Replace with your next game URL
