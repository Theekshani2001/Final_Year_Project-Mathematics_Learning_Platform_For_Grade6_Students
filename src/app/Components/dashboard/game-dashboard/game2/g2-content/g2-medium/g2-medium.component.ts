...
@Component({
  selector: 'app-g2-medium',
  templateUrl: './g2-medium.component.html',
  styleUrls: ['./g2-medium.component.scss']
})
export class G2MediumComponent implements OnInit {

  cards: Card[] = [];
  state = {
    totalFlips: 0,
    totalTime: 0,
    moveLimit: 40, // Example limit
    timeLimit: 240, // Example limit
    loop: null as any
  };
  ...
  startGame(): void {
    const images = ['circle.png', 'hexagon.png', 'octagon.png', 'parallelogram.png', 'pentagon.png', 'square.png', 'trapezoid.png', 'triangle.png', 'cross.png', 'diamond.png'];
