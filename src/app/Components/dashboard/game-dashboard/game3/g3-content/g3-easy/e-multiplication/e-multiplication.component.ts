...
@Component({
  selector: 'app-e-multiplication',
  templateUrl: './e-multiplication.component.html',
  styleUrls: ['./e-multiplication.component.scss']
})
export class EMultiplicationComponent implements OnInit {
