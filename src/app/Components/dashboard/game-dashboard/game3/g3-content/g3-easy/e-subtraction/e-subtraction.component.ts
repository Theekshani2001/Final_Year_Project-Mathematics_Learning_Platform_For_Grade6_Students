...
@Component({
  selector: 'app-e-subtraction',
  templateUrl: './e-subtraction.component.html',
  styleUrls: ['./e-subtraction.component.scss']
})
export class ESubtractionComponent implements OnInit {
