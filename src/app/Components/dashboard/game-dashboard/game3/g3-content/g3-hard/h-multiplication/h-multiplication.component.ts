...
@Component({
  selector: 'app-h-multiplication',
  templateUrl: './h-multiplication.component.html',
  styleUrls: ['./h-multiplication.component.scss']
})
export class HMultiplicationComponent implements OnInit {
