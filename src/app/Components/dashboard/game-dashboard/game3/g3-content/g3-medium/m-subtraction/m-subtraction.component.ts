...
@Component({
  selector: 'app-m-subtraction',
  templateUrl: './m-subtraction.component.html',
  styleUrls: ['./m-subtraction.component.scss']
})
export class MSubtractionComponent implements OnInit {
